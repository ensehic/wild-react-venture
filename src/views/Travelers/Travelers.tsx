    ...
    return (
        <>
            <Container defaultBackground>
                <p>
                    As you traverse the solar system, you&apos;ll likely run into other other members of Outer Wilds Ventures. These encounters are moments
                    of calm amidst all the chaos of your exploration, so do take the opportunity to relax a bit. Sit by the campires, roast some marshmallows
