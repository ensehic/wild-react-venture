        ...
        <Container classNameProp={classes.homeMainContent}>
            ...
            <Container classNameProp={`${classes.homeSubContent} ${classes.intro}`} defaultBackground>
                ...
                <p className={'indented'}>
                    ...
                    Those are all well and good for learning a new technology, of course, but this time around I wanted to create something more personal.
                </p>
                <br/>
                <p className={'indented'}>
                    ...
                    to the lack of exposure is the fact that Outer Wilds was initially an EGS exclusive and was unceremoniously released on Steam in 2020. I myself probably wouldn&apos;t&apos;ve
